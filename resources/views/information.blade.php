...
@section('content')
    ...
    <section class="container py-md-5 my-5">
        ...
        <p>All foreigners require a visa for entry into Nepal (except Indian nationals). It is your responsibility to obtain
            ...
            in US Dollar cash (this is payable in any major currency but NOT traveler's cheque) dependent upon the duration
            of the multiple entry visas:</p>

        <ol class="fw-bold">
            <li>Multiple entries 15 days US$ 30 or equivalent convertible currency</li>
            <li>Multiple entries 30 days US$ 50 or equivalent convertible currency</li>
        ...
        <p>Travel Insurance is mandatory for booking any of Himalayas Nepal Visionâs Adventure packages. Trekking in the
            ...
            and illnesses. Even High altitude sickness can tear up your perfect itinerary. And thatâs where travel
            insurance can save you from distress or at least from some of the costs, depending on the policy you buy. For
            your adventure, Travel insurance is a safety net if things go wrong. At times, even a helicopter may be needed
            along with a rescue team, for ground evacuation, so, every traveler must have rescue insurance covered against
            personal accidents, medical expenses, emergency air ambulance/helicopter rescue service accidents, and personal
            liability. Start your trip with all the necessary health & traveling insurance for your safety.
        ...
        <p>Eating is a big part of traveling. With Nepal Vision, you will experience the vast array of wonderful food that
            ...
            Bhat (rice and lentils), as well as a variety of different food items, such as vegetables, noodles, potatoes
            cuisine served and soup along with some, Nepali versions of western food such as pizza, pasta, and French fries.
            Breakfast and dinner will be served from the teahouse or lodge menu where we will spend the night. Lunch will be
            eaten at one of the trailside restaurants. A welcome dinner, a farewell dinner, and breakfasts will be served
            during our stay in Kathmandu.
            When an individual is allergic to some food products, requires a special diet, or has specific religious food
            needs, we will arrange it as per your requirements on request. Also, the crew will carry fresh, fruit supplies
        ...
        <p>During this trip, we will spend a few nights in Kathmandu at four-star standard hotels. We will spend the nights
            ...
            and very little additional furniture. Blankets are generally provided. Most bathrooms are shared and toilets are
            the western version. Most of the Teahouses have running water facilities while some of them may also have hot
            water available for bathing at an additional cost. It is advisable to carry wet wipes as an alternative.
            There is a large dining room more like the lounge, warmed by an iron cylinder, fitted with a chimney duct, in
        ...
        <p>Nepal is for all seasons! But because of the huge range in altitude and landscape, the climate of Nepal differs
            ...
            clear skies and outstanding views. During monsoons (June, July, Aug) although there will be no problem with
            trekking, the issue could be less visibility and rain. For the student of botanicals, a monsoon is a blessing as
            the higher valleys, mountains, and meadows blossom with flowers and abundant vegetation. You can also trek in
            winter (Dec, Jan, and Feb). Only, the issue will be cold weather with snowfall at higher elevations.
            The trekking routes are filled with trekkers during spring and autumn but during monsoon and winter the routes
            are not packed and you could enjoy rather the best of nature. However, because of the effects of global warming,
            the climate is changing worldwide and there could always be the possibility of exceptions in these weather
        ...
        <p>The Trek Leader of your group has a role to ensure all aspects of the trip run smoothly. Our guides are
            ...
            things, and more on your trekking. Nepal Vision trained its guide/trekking staff on the following course:</p>
        <ol class="fw-bold">
            <li>Intensive Wilderness First Aid</li>
            <li>Trekking Guide Training</li>
            <li>Trekking Workshop and Adventure Meet</li>
            <li>Eco Trekking Workshop and Adventure Meet</li>
        ...
        <p>Altitude is known as elevation, and it is often used to refer to the height above sea level. Altitude is related
            ...
            As the altitude rises, air pressure drops. In other words, if the indicated altitude is high, the air pressure
            becomes low. The human body reacts to high altitudes. Decreased air pressure means that less oxygen is available
            for breathing. One normal effect of altitude is shortness of breath since the lungs have to work harder to
            deliver oxygen to the bloodstream. It can take days and even weeks for a body to adjust to high altitude and low
            air pressure. To prevent severe altitude sickness, mountaineers bring supplemental (extra) supplies of oxygen
            and limit their time in the 'high elevation'.
            Acclimatization We are experts at operating adventure trips at high-altitude destinations. Every trip we run has
            a realistic acclimatization program. Our treks are designed to allow gradual height gain, spread over several
            days. There is no way of predicting who will suffer from altitude but, for the vast majority of people, a slow
            ascent to height will produce minimal effects. Acclimatizing takes time and there are no safe shortcuts. All
