            ...
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class=" col-md-6">
                        ...
                        <input name="link" class='form-control' value=' {{ old('link') }}' type='url'
                            placeholder="Enter Banner url">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Type</label>
                        <select name="type" id="" class="form-control">
                            <option value="1" @if (old('type') == 1) selected @endif>Main</option>
                            <option value="0" @if (old('type') == 0) selected @endif>Pop up</option>
