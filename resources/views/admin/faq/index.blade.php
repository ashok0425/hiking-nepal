        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div> <a class="btn btn-primary" href="{{ route('admin.faqs.create') }}"><i class="fa fa-plus"></i> Add
                            FAQ</a></div>
                            ...
                            @foreach ($faqs as $faq)
                                <tr id="{{ $faq->id }}">
                                    ...
                                    <td>
                                        ...
                                        @if ($faq->status == 1)
                                            <a href="{{ route('admin.deactive', ['id' => $faq->id, 'table' => 'faqs']) }}"
                                                class="btn btn-primary"><i class="fas fa-thumbs-down"></i></a>
                                        @else
                                            <a href="{{ route('admin.active', ['id' => $faq->id, 'table' => 'faqs']) }}"
