                                    ...
                                    <div class="row">
                                            ...
                                            <select name="country" id="" class="form-select form-control" required>
                                                ...
                                                @foreach ($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                        @if ($country->id == $package->country_id) selected @endif>
                                                        {{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="currency" id="" class="form-control"
                                                placeholder="USD,EUR" value="{{ $package->currency }}">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" name="mobile_meta_description" class="form-control"
                                            value="{{ $package->mobile_meta_description }}">
                                    </div>
                                </div>
                            </div>
                        </div>
