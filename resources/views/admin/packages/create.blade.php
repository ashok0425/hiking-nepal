                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea id="itinerary-editor" name="itinerary" class="form-control" rows="10">{{ old('itinerary') }}</textarea>
                            </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="number" class="form-control" name="package_order"  value="{{old('package_order')}}">
                                    ...
                                    @foreach ($activities as $activity)
                                        <div class="form-check me-3 mb-2">
                                            <input class="form-check-input" type="checkbox" name="activities[]"
                                                ...
                                                {{ (old('activities') && in_array($activity->id, old('activities'))) ||
                                                (isset($package) && $package->activities->contains('id', $activity->id))
                                                    ? 'checked'
                                                    : '' }}>
                            ...
                            <div class="form-group">
                                <select name="related_packages[]" class="form-control" multiple size="6">
                                    @foreach ($allPackages as $pkg)
                                        <option value="{{ $pkg->id }}"
                                            {{ old('related_packages') && in_array($pkg->id, old('related_packages')) ? 'selected' : '' }}>
                                            {{ $pkg->title }}
                                        </option>
                                    @endforeach
                                </select>
