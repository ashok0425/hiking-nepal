        ...
        <div class="card py-3 px-4">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('admin.role.create') }}" class="badge bg-info py-2 px-2"><i class="fas fa-plus"></i> Add
                        Role</a>
                </div>
            </div>
                    ...
                    @foreach ($role as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.role.edit', ['id' => $item->id]) }}" class="btn btn-primary"><i
                                        class="far fa-edit"></i></a>
                                <a href="{{ route('admin.role.delete', ['id' => $item->id, 'table' => 'roles']) }}"
                                    class="btn btn-danger delete_row"><i class="fas fa-times"></i></a>
