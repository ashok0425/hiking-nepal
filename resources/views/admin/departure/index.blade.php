        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div> <a class="btn btn-primary" href="{{ route('admin.departures.create') }}"><i class="fa fa-plus"></i>
                            Add departure</a></div>
                            ...
                            @foreach ($departures as $departure)
                                <tr id="{{ $departure->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.departures.delete', $departure->id) }}"
                                            class="btn btn-danger btn-sm delete_row" id=""><i
                                                class="fa fa-trash"></i>
                                        </a>
                                        @if ($departure->status == 1)
                                            <a href="{{ route('admin.deactive', ['id' => $departure->id, 'table' => 'departures']) }}"
                                                class="btn btn-primary"><i class="fas fa-thumbs-down"></i></a>
                                        @else
                                            <a href="{{ route('admin.active', ['id' => $departure->id, 'table' => 'departures']) }}"
