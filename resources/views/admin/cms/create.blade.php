        ...
        <div class="card">
                ...
                <form action="{{ route('admin.cms.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" id="" class="form-control"
                                    value="{{ old('title') }}" placeholder="Enter CMS page title">
                                @if ($errors->has('title'))
                                ...
                                <div class="d-flex">
                                    <label>
                                        <input type="radio" name="main_or_sub" class="main_or_sub" value="1"
                                            @if (old('main_or_sub') == 1) checked @endif> Main
                                    </label>
                                    <label class="mx-3">
                                        <input type="radio" name="main_or_sub" class="main_or_sub" value="0"
                                            @if (old('main_or_sub') === 0) checked @endif> Sub
                                    </label>
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="maincms"
                                class="  @if (old('main_or_sub') === 0) d-block
                @else 
                d-none @endif">
                                    ...
                                    <select name="parent_id" id="" class="form-control">
                                        @foreach ($maincms as $item)
                                            <option value="{{ $item->id }}"
                                                @if ($item->id == old('parent_id')) selected @endif>{{ $item->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                                ...
                                <input type="number" name="position" id="" placeholder="Enter Postion value"
                                    required class="form-control" value="{{ old('position') }}">
                            ...
                            <div class="form-group">
                                <label class="ckbox ckbox-success">
                                    ...
                                    <input type="checkbox" name="hide_header" id="" value="1"
                                        class="form-control" @if (old('hide_header') == 1) checked @endif>
                                </label>
            ...
            {{ old('conntent') }}
                        ...
                        <div class=" col-md-6">
                            ...
                            <input name="keyword" class='form-control' value=' {{ old('keyword') }}' type='text'
                                placeholder="Keyword">
                        </div>

                        <div class=" col-md-6">
                            <label class="form-label"> Meta Title</label>
                            <input name="meta_title" class='form-control' value=' {{ old('meta_title') }}' type='text'
