                    ...
                    <table id="example2" class="table table-bordered table-striped-col">
                        ...
                        <tbody>
                            @foreach ($newsletters as $key => $newsletter)
                                <tr>
                                    <td><input type="checkbox" name="email[]" class="check"
                                            value="{{ $newsletter->email }}"></td>

                                    <td>{{ ++$key }}</td>
                                    <td>{{ $newsletter->email }}</td>
                                    <td>
                                        <a href="{{ route('admin.newsletters.delete', $newsletter->id) }}" id="delete_row"
                                            class="btn btn-danger btn-sm delete_row"><i class="fa fa-trash"></i></a>
                                    </td>
