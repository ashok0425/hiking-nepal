<div class="brand-shadow p-5 mb-5">
    ...
    <h2 class="mb-5">It takes less than 2 minutes to complete your booking process</h2>
    ...
    <form class="form-light">
        ...
        <div class="mb-5">
            <label for="phone" class="form-label fw-bold">Contact Details <span class="text-danger">*</span></label>
        ...
        <div class="mb-5">
            ...
            <textarea class="form-control" placeholder="Write your comment" id="message" name="message" rows="10"></textarea>
        </div>
