<div class="brand-shadow p-5 mb-5">
    <h2 class="mb-5 text-center">Arrival Date <span class="text-danger">*</span></h2>

    <div class="mb-5 mx-auto" id="dateSelectionContainer">
        <input type="hidden" name="selectedDateType" id="selectedDateTypeInput">
        <div class="row">
            <div class="col-md-4">
                <div class="dates-option text-center cursor-pointer " data-value="exact">
            ...
            <div class="col-md-4">
                <div class="dates-option text-center cursor-pointer" data-value="approximate">
                    <div class="d-flex align-items-center gap-2">
                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div class="col-md-4">
                <div class="dates-option text-center cursor-pointer" data-value="flexible">
                    <div class="d-flex align-items-center gap-2">
                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="row mb-2">
        <div class="col-md-3">
            <div class="form-group">
                <label for="tripArrivalDate">Arrival Date</label>
                <input type="date" class="form-control" id="tripArrivalDate" name="tripArrivalDate" required>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label for="tripDepartureDate">Departure Date</label>
                <input type="date" class="form-control" id="tripDepartureDate" name="tripDepartureDate" required>
            </div>
        </div>
    </div>

    <div class="fw-bold text-danger mb-5">Trip start and end date can be changed later if you wish to</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const dateOptionsContainer = document.getElementById('dateSelectionContainer');
        const dateSelectionItems = dateOptionsContainer.querySelectorAll('.dates-option');
        const selectedDateTypeInput = document.getElementById('selectedDateTypeInput');

        dateSelectionItems.forEach(dateOption => {
            dateOption.addEventListener('click', function() {
                dateSelectionItems.forEach(item => item.classList.remove('selected'));
                this.classList.add('selected');
                selectedDateTypeInput.value = this.dataset.value;
            });
        });
    });
</script>
